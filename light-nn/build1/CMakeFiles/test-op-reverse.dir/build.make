...
CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.o: ../test/test-op-reverse.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/volume/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.o -c /volume/light-nn/test/test-op-reverse.cc
...
CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /volume/light-nn/test/test-op-reverse.cc > CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.i
...
CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /volume/light-nn/test/test-op-reverse.cc -o CMakeFiles/test-op-reverse.dir/test/test-op-reverse.cc.s
...
test/test-op-reverse: lib/openblas.lib
test/test-op-reverse: CMakeFiles/test-op-reverse.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/volume/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test/test-op-reverse"
...
CMakeFiles/test-op-reverse.dir/depend:
	cd /volume/light-nn/build1 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /volume/light-nn /volume/light-nn /volume/light-nn/build1 /volume/light-nn/build1 /volume/light-nn/build1/CMakeFiles/test-op-reverse.dir/DependInfo.cmake --color=$(COLOR)
