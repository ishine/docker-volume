...
CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.o: ../test/test-op-sigmoid.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/volume/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.o -c /volume/light-nn/test/test-op-sigmoid.cc
...
CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /volume/light-nn/test/test-op-sigmoid.cc > CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.i
...
CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /volume/light-nn/test/test-op-sigmoid.cc -o CMakeFiles/test-op-sigmoid.dir/test/test-op-sigmoid.cc.s
...
test/test-op-sigmoid: lib/openblas.lib
test/test-op-sigmoid: CMakeFiles/test-op-sigmoid.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/volume/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test/test-op-sigmoid"
...
CMakeFiles/test-op-sigmoid.dir/depend:
	cd /volume/light-nn/build1 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /volume/light-nn /volume/light-nn /volume/light-nn/build1 /volume/light-nn/build1 /volume/light-nn/build1/CMakeFiles/test-op-sigmoid.dir/DependInfo.cmake --color=$(COLOR)
