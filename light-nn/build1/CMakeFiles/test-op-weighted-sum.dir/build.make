...
CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.o: ../test/test-op-weighted-sum.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/pycharm-projects/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.o"
	/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.o -c /pycharm-projects/light-nn/test/test-op-weighted-sum.cc
...
CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.i: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /pycharm-projects/light-nn/test/test-op-weighted-sum.cc > CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.i
...
CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.s: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /pycharm-projects/light-nn/test/test-op-weighted-sum.cc -o CMakeFiles/test-op-weighted-sum.dir/test/test-op-weighted-sum.cc.s
...
test/test-op-weighted-sum: lib/libopenblas.a
test/test-op-weighted-sum: CMakeFiles/test-op-weighted-sum.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/pycharm-projects/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test/test-op-weighted-sum"
...
CMakeFiles/test-op-weighted-sum.dir/depend:
	cd /pycharm-projects/light-nn/build1 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /pycharm-projects/light-nn /pycharm-projects/light-nn /pycharm-projects/light-nn/build1 /pycharm-projects/light-nn/build1 /pycharm-projects/light-nn/build1/CMakeFiles/test-op-weighted-sum.dir/DependInfo.cmake --color=$(COLOR)
