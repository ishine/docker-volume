...
CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.o: ../test/test-op-linear.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/pycharm-projects/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.o"
	/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.o -c /pycharm-projects/light-nn/test/test-op-linear.cc
...
CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.i: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /pycharm-projects/light-nn/test/test-op-linear.cc > CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.i
...
CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.s: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /pycharm-projects/light-nn/test/test-op-linear.cc -o CMakeFiles/test-op-linear.dir/test/test-op-linear.cc.s
...
test/test-op-linear: lib/libopenblas.a
test/test-op-linear: CMakeFiles/test-op-linear.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/pycharm-projects/light-nn/build1/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test/test-op-linear"
...
CMakeFiles/test-op-linear.dir/depend:
	cd /pycharm-projects/light-nn/build1 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /pycharm-projects/light-nn /pycharm-projects/light-nn /pycharm-projects/light-nn/build1 /pycharm-projects/light-nn/build1 /pycharm-projects/light-nn/build1/CMakeFiles/test-op-linear.dir/DependInfo.cmake --color=$(COLOR)
