...
TEST_F(ReductionTest, TypeLast) {
  m_config["param"]["type"] = "LAST";
  lnn::Reduction reduction(m_config);
  ...
  EXPECT_TRUE(reduction.forward(m_input_vec, m_output_vec));
