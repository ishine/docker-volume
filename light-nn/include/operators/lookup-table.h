...
//
#ifndef LNN_OPERATORS_LOOKUP_TABLE_H_
#define LNN_OPERATORS_LOOKUP_TABLE_H_

#include "operator.h"

namespace lnn {

class LookupTable : public Operator {
 public:
  LookupTable(const Json::Value &config);
  virtual ~LookupTable();
...
#endif  // LNN_OPERATORS_LOOKUP_TABLE_H_
